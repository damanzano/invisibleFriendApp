...
public class EsAmigoDePK implements Serializable {
    ...
    public String toString() {
        return "co.edu.icesi.entitys.EsAmigoDePK[ numeroEsAmigo=" + numeroEsAmigo + ", numJuegoEsAmigo=" + numJuegoEsAmigo + ", numeroAmigoDe=" + numeroAmigoDe + ", numJuegoAmigoDe=" + numJuegoAmigoDe + " ]";
    }
